...
def detect_network_latency():
    print("Detecting Network Latency issues...")
...
def create_github_issue(instance_id):
    ...
    issue_title = f"EC2 Instance {instance_id} Network Latency Detected"
    issue_body = f"The CloudWatch alarm for EC2 instance {instance_id} is in the ALARM state, indicating high Network Letency. Remediation action is required."
